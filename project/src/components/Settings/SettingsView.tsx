...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  const [activeSection, setActiveSection] = useState<'main' | 'privacy' | 'help' | 'privacy-policy'>('main');
  ...
  if (activeSection === 'privacy') {
    return (
      <PrivacySettings
        ...
        onViewPrivacyPolicy={() => setActiveSection('privacy-policy')}
      />
    );
  }
  ...
  if (activeSection === 'privacy-policy') {
    return (
      <PrivacyPolicyView onBack={() => setActiveSection('privacy')} />
    );
  }
